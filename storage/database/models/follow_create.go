...
func (fc *FollowCreate) SetFollowID(i int64) *FollowCreate {
	fc.mutation.SetFollowID(i)
	return fc
}

// SetNillableFollowID sets the "follow_id" field if the given value is not nil.
func (fc *FollowCreate) SetNillableFollowID(i *int64) *FollowCreate {
	if i != nil {
		fc.SetFollowID(*i)
	}
	return fc
...
func (fc *FollowCreate) check() error {
	if _, ok := fc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`models: missing required field "Follow.created_at"`)}
	}
	return nil
}
...
func (fc *FollowCreate) createSpec() (*Follow, *sqlgraph.CreateSpec) {
	...
	if value, ok := fc.mutation.FollowID(); ok {
