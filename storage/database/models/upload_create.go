...
func (uc *UploadCreate) SetUUID(u uuid.UUID) *UploadCreate {
	uc.mutation.SetUUID(u)
	return uc
}

// SetNillableUUID sets the "uuid" field if the given value is not nil.
func (uc *UploadCreate) SetNillableUUID(u *uuid.UUID) *UploadCreate {
	if u != nil {
		uc.SetUUID(*u)
	}
	return uc
...
func (uc *UploadCreate) SetNillableName(s *string) *UploadCreate {
	if s != nil {
		uc.SetName(*s)
	}
	return uc
...
func (uc *UploadCreate) check() error {
	if _, ok := uc.mutation.UUID(); !ok {
		return &ValidationError{Name: "uuid", err: errors.New(`models: missing required field "Upload.uuid"`)}
	}
