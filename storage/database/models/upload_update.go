...
func (uu *UploadUpdate) SetUUID(u uuid.UUID) *UploadUpdate {
	uu.mutation.SetUUID(u)
	return uu
}

// SetNillableUUID sets the "uuid" field if the given value is not nil.
func (uu *UploadUpdate) SetNillableUUID(u *uuid.UUID) *UploadUpdate {
	if u != nil {
		uu.SetUUID(*u)
	}
	return uu
...
func (uu *UploadUpdate) ClearName() *UploadUpdate {
...
func (uu *UploadUpdate) check() error {
	if v, ok := uu.mutation.Name(); ok {
		if err := upload.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`models: validator failed for field "Upload.name": %w`, err)}
		}
	}
	return nil
}
...
func (uu *UploadUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.UUID(); ok {
		_spec.SetField(upload.FieldUUID, field.TypeUUID, value)
	}
	if value, ok := uu.mutation.Name(); ok {
		_spec.SetField(upload.FieldName, field.TypeString, value)
	}
	if uu.mutation.NameCleared() {
		_spec.ClearField(upload.FieldName, field.TypeString)
	}
...
// SetUUID sets the "uuid" field.
func (uuo *UploadUpdateOne) SetUUID(u uuid.UUID) *UploadUpdateOne {
	uuo.mutation.SetUUID(u)
	return uuo
}

// SetNillableUUID sets the "uuid" field if the given value is not nil.
func (uuo *UploadUpdateOne) SetNillableUUID(u *uuid.UUID) *UploadUpdateOne {
	if u != nil {
		uuo.SetUUID(*u)
	}
	return uuo
...
// ClearName clears the value of the "name" field.
func (uuo *UploadUpdateOne) ClearName() *UploadUpdateOne {
...
func (uuo *UploadUpdateOne) sqlSave(ctx context.Context) (_node *Upload, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`models: missing "Upload.id" for update`)}
	}
