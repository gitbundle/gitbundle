...
func (md *MirrorDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(mirror.Table, sqlgraph.NewFieldSpec(mirror.FieldID, field.TypeInt))
...
// Where appends a list predicates to the MirrorDelete builder.
func (mdo *MirrorDeleteOne) Where(ps ...predicate.Mirror) *MirrorDeleteOne {
...
func (mdo *MirrorDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{mirror.Label}
	default:
		return nil
	}
}
