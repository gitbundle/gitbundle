...
func (uq *UserQuery) QueryRepos() *RepoQuery {
	query := (&RepoClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withRepos; query != nil {
		if err := uq.loadRepos(ctx, query, nodes,
			func(n *User) { n.Edges.Repos = []*Repo{} },
			func(n *User, e *Repo) { n.Edges.Repos = append(n.Edges.Repos, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadRepos(ctx context.Context, query *RepoQuery, nodes []*User, init func(*User), assign func(*User, *Repo)) error {
