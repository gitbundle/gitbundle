...
func (rq *RepoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Repo, error) {
	...
	if query := rq.withOwner; query != nil {
		if err := rq.loadOwner(ctx, query, nodes, nil,
			func(n *Repo, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (rq *RepoQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Repo, init func(*Repo), assign func(*Repo, *User)) error {
