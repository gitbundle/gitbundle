...
func (au *AttachmentUpdate) SetNillableUUID(s *string) *AttachmentUpdate {
	if s != nil {
		au.SetUUID(*s)
	}
	return au
...
func (au *AttachmentUpdate) ClearUUID() *AttachmentUpdate {
...
func (au *AttachmentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if au.mutation.UUIDCleared() {
		_spec.ClearField(attachment.FieldUUID, field.TypeString)
	}
...
// SetNillableUUID sets the "uuid" field if the given value is not nil.
func (auo *AttachmentUpdateOne) SetNillableUUID(s *string) *AttachmentUpdateOne {
	if s != nil {
		auo.SetUUID(*s)
	}
	return auo
...
// ClearUUID clears the value of the "uuid" field.
func (auo *AttachmentUpdateOne) ClearUUID() *AttachmentUpdateOne {
