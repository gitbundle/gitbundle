...
func (tc *TeamCreate) SetNillableTeamID(i *int64) *TeamCreate {
	if i != nil {
		tc.SetTeamID(*i)
	}
	return tc
...
func (tc *TeamCreate) SetRepoID(i int64) *TeamCreate {
	tc.mutation.SetRepoID(i)
	return tc
}

// SetNillableRepoID sets the "repo_id" field if the given value is not nil.
func (tc *TeamCreate) SetNillableRepoID(i *int64) *TeamCreate {
	if i != nil {
		tc.SetRepoID(*i)
	}
	return tc
