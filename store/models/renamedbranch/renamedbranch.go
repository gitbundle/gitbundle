...
const (
	// Label holds the string label denoting the renamedbranch type in the database.
	Label = "renamed_branch"
	...
	// Table holds the table name of the renamedbranch in the database.
	Table = "renamed_branches"
)

// Columns holds all SQL columns for renamedbranch fields.
var Columns = []string{
	FieldID,
	FieldRepoID,
	FieldFrom,
...
// OrderOption defines the ordering options for the RenamedBranch queries.
