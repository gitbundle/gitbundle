...
// RepoCount applies equality check predicate on the "repo_count" field. It's identical to RepoCountEQ.
func RepoCount(v int) predicate.Topic {
	return predicate.Topic(sql.FieldEQ(FieldRepoCount, v))
}
...
// RepoCountEQ applies the EQ predicate on the "repo_count" field.
func RepoCountEQ(v int) predicate.Topic {
	return predicate.Topic(sql.FieldEQ(FieldRepoCount, v))
}

// RepoCountNEQ applies the NEQ predicate on the "repo_count" field.
func RepoCountNEQ(v int) predicate.Topic {
	return predicate.Topic(sql.FieldNEQ(FieldRepoCount, v))
}

// RepoCountIn applies the In predicate on the "repo_count" field.
func RepoCountIn(vs ...int) predicate.Topic {
	return predicate.Topic(sql.FieldIn(FieldRepoCount, vs...))
}

// RepoCountNotIn applies the NotIn predicate on the "repo_count" field.
func RepoCountNotIn(vs ...int) predicate.Topic {
	return predicate.Topic(sql.FieldNotIn(FieldRepoCount, vs...))
}

// RepoCountGT applies the GT predicate on the "repo_count" field.
func RepoCountGT(v int) predicate.Topic {
	return predicate.Topic(sql.FieldGT(FieldRepoCount, v))
}

// RepoCountGTE applies the GTE predicate on the "repo_count" field.
func RepoCountGTE(v int) predicate.Topic {
	return predicate.Topic(sql.FieldGTE(FieldRepoCount, v))
}

// RepoCountLT applies the LT predicate on the "repo_count" field.
func RepoCountLT(v int) predicate.Topic {
	return predicate.Topic(sql.FieldLT(FieldRepoCount, v))
}

// RepoCountLTE applies the LTE predicate on the "repo_count" field.
func RepoCountLTE(v int) predicate.Topic {
	return predicate.Topic(sql.FieldLTE(FieldRepoCount, v))
}

// RepoCountIsNil applies the IsNil predicate on the "repo_count" field.
func RepoCountIsNil() predicate.Topic {
	return predicate.Topic(sql.FieldIsNull(FieldRepoCount))
}

// RepoCountNotNil applies the NotNil predicate on the "repo_count" field.
func RepoCountNotNil() predicate.Topic {
	return predicate.Topic(sql.FieldNotNull(FieldRepoCount))
}
