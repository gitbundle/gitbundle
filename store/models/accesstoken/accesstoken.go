...
var (
	...
	// TokenSaltValidator is a validator for the "token_salt" field. It is called by the builders before save.
	TokenSaltValidator func(string) error
	// TokenLastEightValidator is a validator for the "token_last_eight" field. It is called by the builders before save.
	TokenLastEightValidator func(string) error
